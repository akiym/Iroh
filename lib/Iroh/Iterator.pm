...
Iroh::Iterator - Iterator for Iroh

=head1 DESCRIPTION

This is an iterator class for L<Iroh>.
...
=item $itr = Iroh::Iterator->new()

Create new Iroh::Iterator's object. You may not call this method directly.
