...
sub update {
    ...
    if (ref($self) eq 'Iroh::Row') {
        Carp::croak q{can't update from basic Iroh::Row class.};
    }
...
sub delete {
    ...
    if (ref($self) eq 'Iroh::Row') {
        Carp::croak q{can't delete from basic Iroh::Row class.};
    }
...
Iroh::Row - Iroh's Row class

=head1 METHODS

=over

=item $row = Iroh::Row->new

create new Iroh::Row's instance
