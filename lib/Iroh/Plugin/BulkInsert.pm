package Iroh::Plugin::BulkInsert;
use strict;
use warnings;
use utf8;
...
warn "IMPORTANT: Iroh::Plugin::BulkInsert is DEPRECATED AND *WILL* BE REMOVED. DO NOT USE.\n";
...
Iroh::Plugin::BulkInsert - (DEPRECATED) bulk insert helper
