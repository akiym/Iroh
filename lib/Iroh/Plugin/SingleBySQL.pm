package Iroh::Plugin::SingleBySQL;
use strict;
use warnings;
use utf8;
...
warn "IMPORTANT: Iroh::Plugin::SingleBySQL is DEPRECATED AND *WILL* BE REMOVED. Because into the Iroh core. DO NOT USE.\n";
...
Iroh::Plugin::SingleBySQL - (DEPRECATED)single by sql
