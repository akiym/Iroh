package Iroh::Plugin::Pager::MySQLFoundRows;
use strict;
use warnings;
use utf8;
use Data::Page;
...
Iroh::Plugin::Pager::MySQLFoundRows - Paginate with SQL_CALC_FOUND_ROWS
...
This method returns ArrayRef[Iroh::Row] and instance of L<Iroh::Plugin::Pager::Page>.
